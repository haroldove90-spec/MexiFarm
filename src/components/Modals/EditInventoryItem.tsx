...
const EditInventoryItem: React.FC<EditInventoryItemProps> = ({ item, onClose, onSuccess }) => {
  const {
    register,
    handleSubmit,
  ...
  const onSubmit = async (data: InventoryFormData) => {
    ...
    try {
      ...
      alert('Error al sincronizar inventario. Los cambios locales se mantienen.');
    }
  };
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Gestión de stock y costos</p>
            </div>
          </div>
